...
// Query to get the total count of matching records
$countQuery = "SELECT COUNT(*) as total FROM db_name.transactions WHERE DATE(created_at) BETWEEN :start_date AND :end_date";
...
$query = "SELECT * FROM db_name.transactions WHERE DATE(created_at) BETWEEN :start_date AND :end_date ORDER BY created_at DESC LIMIT :limit OFFSET :offset";
